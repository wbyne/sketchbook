...
String dataString = "SpamSpamSpamSpamSpamSpamSpamSpamSpamSpam1234567890";
...
//  mySerial.println("AT + CMGS = \"111\"");//send sms message, be careful need to add a country code before the cellphone number
  mySerial.println("AT + CMGS = \"500\"");//send sms message, be careful need to add a country code before the cellphone number
  delay(100);
//  mySerial.print("wbyne@augustaga.gov Hello:");//the content of the message
  mySerial.print("fbyne@watergeorgia.com#Hello:#");//the content of the message  someone recommended address#subject#text
  delay(100);
  mySerial.print("\r");
  delay(100);
  mySerial.print("\r");
...
void SendTextMessage()
{
  ...
  delay(100);
  mySerial.println();
// shut down the shield  powerUpOrDown();
}
///DialVoiceCall
///this function is to dial a voice call
void DialVoiceCall()
{
  mySerial.println("ATD + +17065139486;");//dial the number
//  mySerial.println("ATD + +18034292683;");//dial the number
  delay(100);
  mySerial.println();
}
