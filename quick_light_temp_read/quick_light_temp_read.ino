#define LIGHT_READ 5
#define TEMP_READ 3
#define WINDVANE_PIN 3
#define WV_INT 1
#define MSECS_TO_CALC 5000
#define WIND_FACTOR 5.0 //change per the instrument radius
...
//  Serial.print("\n");                                  //add a carriage return, linefeed
  ...
  Serial.print(windSpeed);        //print the rain depth
  Serial.print(" furlongs per season\n");      //print in inches
